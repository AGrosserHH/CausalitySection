...
vi.mock('../workspace/client.js',()=>({default:{get:mocks.get,post:mocks.post},workspaceState:mocks.state}))
...
function app(){return mount(AnalysisPanel,{props:{graphId:1,variables:[{id:1,name:'T'},{id:2,name:'Y'},{id:3,name:'X'}],treatmentId:1,outcomeId:2,prepareGraph:async()=>true}})}
function button(w,label){return w.findAll('button').find(b=>b.text()===label)}
describe('Reviewed comparison panel',()=>{
