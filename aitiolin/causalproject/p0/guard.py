...
def guard(view, operation):
    ...
    def secured(request, *args, **kwargs):
        ...
        try:
            ...
            if not operation.startswith("p0_") and operation not in {"upload_csv", "variables", "openai_suggest_edges"} and graph is None:
            ...
            if graph is not None:
                ...
                if isinstance(data, dict) and data.get("graph_image"):
                    data["graph_image"] = f"/api/p0/graphs/{graph.pk}/image/"
            ...
            if before is not None:
                ...
                if isinstance(data, dict):
                    data["p0_run_id"] = str(record.pk)
                    data["p0_analysis_key"] = record.analysis_key
